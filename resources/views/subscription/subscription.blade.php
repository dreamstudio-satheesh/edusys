                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-4">
                            ...
                            <input type="text" name="name" value="{{ $active_package ? $active_package->name : '' }}" class="form-control form-control-sm" readonly>
                        </div>

                        <!-- Start Date Field -->
                        <div class="form-group col-sm-12 col-md-4">
                            <label for="start_date">{{ __('start_date') }}</label>
                            <input type="text" name="start_date" value="{{ $active_package ? format_date($active_package->start_date) : '' }}" class="form-control form-control-sm" readonly>
                        </div>

                        <!-- End Date Field -->
                        <div class="form-group col-sm-12 col-md-4">
                            <label for="end_date">{{ __('end_date') }}</label>
                            <input type="text" name="end_date" value="{{ $active_package ? format_date($active_package->end_date) : '' }}" class="form-control form-control-sm" readonly>
                        </div>

                        @if ($active_package && $active_package->package_type == 1)
                        <!-- Per Active Student Charges -->
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="student_charge">{{ __('per_active_student_charges') }} ({{ $system_settings['currency_symbol'] }})</label>
                            <input type="text" name="student_charge" value="{{ $active_package ? $active_package->student_charge : '' }}" class="form-control form-control-sm" readonly>
                        </div>

                        <!-- Per Active Staff Charges -->
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="staff_charge">{{ __('per_active_staff_charges') }} ({{ $system_settings['currency_symbol'] }})</label>
                            <input type="text" name="staff_charge" value="{{ $active_package ? $active_package->staff_charge : '' }}" class="form-control form-control-sm" readonly>
                        </div>
                        @else
                        <!-- Student Limit -->
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="student_limit">{{ __('student_limit') }}</label>
                            <input type="text" name="student_limit" value="{{ $active_package ? $active_package->no_of_students : '' }}" class="form-control form-control-sm" readonly>
                        </div>

                        <!-- Staff Limit -->
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="staff_limit">{{ __('staff_limit') }}</label>
                            <input type="text" name="staff_limit" value="{{ $active_package ? $active_package->no_of_staffs : '' }}" class="form-control form-control-sm" readonly>
                        </div>
                        @endif
                    </div>
