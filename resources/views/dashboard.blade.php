            ...
            <div class="card-body custom-card-body">
                <div class="row">
                    ...
                    <select name="birthday_filter" class="form-control form-control-sm filter_birthday">
                        <option value="today" {{ old('birthday_filter', 'today') == 'today' ? 'selected' : '' }}>{{ __('today') }}</option>
                        <option value="this_month" {{ old('birthday_filter') == 'this_month' ? 'selected' : '' }}>{{ __('this_month') }}</option>
                        <option value="next_month" {{ old('birthday_filter') == 'next_month' ? 'selected' : '' }}>{{ __('next_month') }}</option>
                    </select>
