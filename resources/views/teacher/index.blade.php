                    ...
                    <form class="create-form pt-3" id="formdata" action="{{ route('teachers.store') }}" enctype="multipart/form-data" method="POST" novalidate="novalidate">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <input type="text" name="email" required placeholder="{{ __('email') }}" class="form-control" />
                            </div>

                            <!-- First Name Field -->
                            <div class="form-group col-sm-12 col-md-4">
                                <label>{{ __('first_name') }} <span class="text-danger">*</span></label>
                                <input type="text" name="first_name" required placeholder="{{ __('first_name') }}" class="form-control" />
                            </div>

                            <!-- Last Name Field -->
                            <div class="form-group col-sm-12 col-md-4">
                                <label>{{ __('last_name') }} <span class="text-danger">*</span></label>
                                <input type="text" name="last_name" required placeholder="{{ __('last_name') }}" class="form-control" />
                            </div>
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <input type="number" name="mobile" required min="1" placeholder="{{ __('mobile') }}" class="form-control remove-number-increment" />
                            </div>
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <textarea name="qualification" required placeholder="{{ __('qualification') }}" class="form-control" rows="3"></textarea>
                            </div>
                            ...
                            <!-- Status Radio Buttons (Only if Teacher Management feature is enabled) -->
                            ...
                            <div class="form-group col-sm-12 mt-4">
                                <button type="button" class="btn btn-inverse-success add-allowance-div" data-repeater-create>
                            ...
                            <div class="form-group col-sm-12 mt-4">
                                <button type="button" class="btn btn-inverse-success add-deduction-div" data-repeater-create>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('email') }} <span class="text-danger">*</span></label>
                            <input type="text" name="email" required placeholder="{{ __('email') }}" class="form-control" id="email" />
                        </div>

                        <!-- First Name Field -->
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('first_name') }} <span class="text-danger">*</span></label>
                            <input type="text" name="first_name" required placeholder="{{ __('first_name') }}" class="form-control" id="first_name" />
                        </div>

                        <!-- Last Name Field -->
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('last_name') }} <span class="text-danger">*</span></label>
                            <input type="text" name="last_name" required placeholder="{{ __('last_name') }}" class="form-control" id="last_name" />
                        </div>
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="d-flex">
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gender" value="male" class="form-check-input edit" id="gender_male" />
                                    <label class="form-check-label" for="gender_male">{{ __('male') }}</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="gender" value="female" class="form-check-input edit" id="gender_female" />
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('mobile') }} <span class="text-danger">*</span></label>
                            <input type="number" name="mobile" required min="1" placeholder="{{ __('mobile') }}" class="form-control remove-number-increment" id="mobile" />
                        </div>

                        <!-- Date of Birth Field -->
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('dob') }} <span class="text-danger">*</span></label>
                            <input type="text" name="dob" required placeholder="{{ __('dob') }}" class="datepicker-popup-no-future form-control" id="edit-dob" autocomplete="off" />
                        </div>
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('qualification') }} <span class="text-danger">*</span></label>
                            <textarea name="qualification" required placeholder="{{ __('qualification') }}" class="form-control" rows="3" id="qualification"></textarea>
                        </div>

                        <!-- Current Address Textarea -->
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('current_address') }} <span class="text-danger">*</span></label>
                            <textarea name="current_address" required placeholder="{{ __('current_address') }}" class="form-control" rows="3" id="current_address"></textarea>
                        </div>

                        <!-- Permanent Address Textarea -->
                        <div class="form-group col-sm-12 col-md-12 col-lg-4">
                            <label>{{ __('permanent_address') }} <span class="text-danger">*</span></label>
                            <textarea name="permanent_address" required placeholder="{{ __('permanent_address') }}" class="form-control" rows="3" id="permanent_address"></textarea>
                        </div>
