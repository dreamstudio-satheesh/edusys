                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-5">
                                ...
                                <select name="category_id" class="form-control" required>
                                    ...
                                    @foreach($expenseCategory as $value => $label)
                                    <option value="{{ $value }}" {{ old('category_id') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-sm-12 col-md-3">
                                ...
                                <select name="session_year_id" class="form-control" required>
                                    ...
                                    <option value="{{ $value }}" {{ old('session_year_id', $current_session_year->id) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="row" id="toolbar">
                        ...
                        <div class="form-group col-sm-12 col-md-4">
                            ...
                            <select name="category_id" id="filter_category_id" class="form-control">
                                ...
                                @foreach($expenseCategory + ['salary' => __('salary')] as $value => $label)
                                <option value="{{ $value }}" {{ old('category_id') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        </div>
