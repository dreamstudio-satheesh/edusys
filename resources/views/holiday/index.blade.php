                    ...
                    <div class="row" id="toolbar">
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-3 col-lg-3">
                            ...
                            <select name="month" id="filter_month" class="form-control">
                                <option value="0">All</option> @foreach($months as $key => $month) <option value="{{ $key }}">{{ $month }}</option> @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 col-md-12">
                            <label>{{ __('date') }} <span class="text-danger">*</span></label>
                            <input type="text" name="date" id="edit-date" class="datepicker-popup form-control" placeholder="{{ __('date') }}" required>
                            <span class="input-group-addon input-group-append">
                            </span>
                        </div>
                    </div>
