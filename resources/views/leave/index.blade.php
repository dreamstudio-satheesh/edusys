            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('leave.store') }}" class="create-form pt-3" novalidate="novalidate"
                        ...
                        @csrf
                        <div class="row">
                            <input type="hidden" name="leave_master_id" value="{{ $leaveMaster->id ?? '' }}" class="form-control">
                            <input type="hidden" name="holiday_days" value="{{ $leaveMaster->holiday ?? '' }}" class="form-control holiday_days">
                            <input type="hidden" name="public_holiday" value="{{ $holiday ?? '' }}" class="form-control public_holiday">
                ...
                <form id="formdata" class="edit-form" action="{{ url('leave') }}" novalidate="novalidate">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <div class="col-sm-12 col-md-12">
                                <label>{{ __('from_date') }} <span class="text-danger">*</span></label>
                                <input type="text" name="from_date" id="edit_from_date" class="form-control datepicker-popup datepicker-popup-no-past" placeholder="{{ __('from_date') }}" required disabled>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-sm-12 col-md-12">
                                <label>{{ __('to_date') }} <span class="text-danger">*</span></label>
                                <input type="text" name="to_date" id="edit_to_date" class="form-control datepicker-popup datepicker-popup-no-past" placeholder="{{ __('to_date') }}" required disabled>
                            </div>
                        </div>
