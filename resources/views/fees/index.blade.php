                        ...
                        <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                            ...
                            <div class="row col-12">
                                <div class="form-group col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" placeholder="{{ __('Prefix Name') }}" class="form-control" required>
                                </div>
                        ...
                        <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                            ...
                            <div class="col-12 row">
                                <div class="form-group col-sm-12 col-md-6 col-lg-3">
                                    ...
                                    <input type="text" name="due_date" value="{{ old('due_date') }}" class="datepicker-popup-no-past form-control" placeholder="{{ __('due_date') }}" required autocomplete="off">
                                </div>

                                <div class="form-group col-sm-12 col-md-6 col-lg-3">
                                    <label>{{ __('due_charges')}} <span class="text-danger">*</span> <span class="text-info small">( {{__('in_percentage')}} )</span></label>
                                    <input type="number" name="due_charges_percentage" id="due_charges_percentage" value="{{ old('due_charges_percentage') }}" class="form-control" placeholder="{{ __('due_charges') }}" required min="0">
                                </div>

                                <div class="form-group col-sm-12 col-md-6 col-lg-3">
                                    <label>{{ __('due_charges')}} <span class="text-danger">*</span> <span class="text-info small">( {{__('Amount')}} )</span></label>
                                    <input type="number" name="due_charges_amount" id="due_charges_amount" value="{{ old('due_charges_amount') }}" class="form-control" placeholder="{{ __('due_charges') }}" required min="0">
                                </div>
                            </div>
                        </div>
                        <div class="border border-secondary rounded-lg mb-2 p-2 mb-3">
                            ...
                            <div class="fees-installment-repeater" style="display: none">
                                <div data-repeater-list="fees_installments">
                                    <div data-repeater-item class="col-12 row">
                                        ...
                                        <div class="form-group col-lg-12 col-xl-3">
                                            <label>{{ __('due_date') }} <span class="text-danger">*</span></label>
                                            <input type="text" name="due_date" value="{{ old('due_date') }}" class="datepicker-popup-no-past form-control installment-due-date" placeholder="{{ __('due_date') }}" autocomplete="off" required>
                                        </div>
                                            ...
                                            <div>
                                                <div class="form-check form-check-inline my-0 d-flex">
                                                    <label class="form-check-label mr-2">
                                                        <input type="radio" name="due_charges_type" value="fixed" class="form-check-input" required>
                                                        {{ __('Fixed Amount') }}
                                                ...
                                                <div class="form-check form-check-inline my-0 d-flex">
                                                    <label class="form-check-label mr-2">
                                                        <input type="radio" name="due_charges_type" value="percentage" class="form-check-input" required checked>
                                                        {{ __('Percentage') }}
                                                        <i class="input-helper"></i>
                                                    </label>
                                        ...
                                        <div class="form-group col-lg-12 col-xl-3">
                                            ...
                                            <input type="number" name="due_charges" value="{{ old('due_charges') }}" class="installment-due-charges form-control" placeholder="{{ trans('due_charges') }}" required data-convert="number" min="0">
                                        </div>
                    ...
                    <div class="row" id="toolbar">
                        <div class="form-group col-sm-12 col-md-3">
                            ...
                            <select name="session_year_id" id="filter_session_year_id" class="form-control">
                                @foreach($sessionYear as $value => $label)
                                <option value="{{ $value }}" {{ old('session_year_id', $defaultSessionYear->id) == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-sm-12 col-md-3">
                            ...
                            <select name="medium_id" id="filter_medium_id" class="form-control">
                                ...
                                <option value="{{ $value }}" {{ old('medium_id') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
