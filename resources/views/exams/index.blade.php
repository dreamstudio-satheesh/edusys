                    ...
                    <form class="pt-3 mt-6 add-exam-form create-form" data-success-function="formSuccessFunction" method="POST" action="{{ url('exams') }}">
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12 col-lg-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="{{ trans('Exam Name') }}" class="form-control" required>
                            </div>
                            <div class="form-group col-sm-12 col-md-12 col-lg-4">
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <textarea name="description" id="description" placeholder="{{ trans('Exam Description') }}" class="form-control" rows="3">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-12">
                                    <label>{{ __('Exam Name') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="name" id="edit_name" value="{{ old('name') }}" placeholder="{{ trans('Exam Name') }}" class="form-control" required>
                                </div>
                                <div class="form-group col-12">
                                    <label>{{ __('Exam Description') }}</label>
                                    <textarea name="description" id="edit_description" placeholder="{{ trans('Exam Description') }}" class="form-control" rows="3">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
