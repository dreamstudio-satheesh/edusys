                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-3">
                                ...
                                <select name="certificate_template_id" id="certificate_template_id" class="form-control" required>
                                    <option value="">{{ __('certificate') . ' ' . __('template') }}</option>
                                    @foreach($certificateTemplates as $value => $label)
                                    <option value="{{ $value }}" {{ old('certificate_template_id') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row" id="toolbar">
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <select name="class_section_id" id="filter_class_section_id" class="form-control">
                                    ...
                                    @foreach($classSections as $value => $label)
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <select name="session_year_id" id="session_year_id" class="form-control">
                                    <option value="">{{ __('all') }}</option>
                                    @foreach($sessionYears as $value => $label)
                                    <option value="{{ $value }}" {{ old('session_year_id') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            </div>
