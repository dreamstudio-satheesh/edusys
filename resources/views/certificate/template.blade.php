                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <select name="page_layout" class="form-control page_layout">
                                    <option value="A4 Landscape" {{ old('page_layout', 'A4 Landscape') == 'A4 Landscape' ? 'selected' : '' }}>A4 Landscape</option>
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <select name="user_image_shape" class="form-control">
                                    <option value="Round" {{ old('user_image_shape', 'Round') == 'Round' ? 'selected' : '' }}>Round</option>
