                    ...
                    <form class="pt-3 mt-6" id="edit-online-exam-questions-form" method="POST" action="{{ route('online-exam-question.index') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" value="{{ $onlineExamQuestion->class_section_with_medium }}" class="form-control" readonly>
                                {{-- <input type="hidden" name="class_section" value="{{ $onlineExamQuestion->class_section_id }}"> --}}
                            </div>
                            <div class="form-group col-md-6">
                                <label>{{ __('subject') }} <span class="text-danger">*</span></label>
                                <input type="text" value="{{ $onlineExamQuestion->subject_with_name }}" class="form-control" readonly>
                                {{-- <input type="hidden" name="subject_id" value="{{ $onlineExamQuestion->subject_id }}"> --}}
                            </div>
                        </div>
                            ...
                            <div class="options-data">
                                <div data-repeater-list="option_data" class="row">
                                    <div class="form-group col-lg-6 col-md-12" data-repeater-item>
                                        <input type="hidden" name="id" value="" class="option-id">
...
<script>
    $(document).ready(function() {
        ...
        $("#remove-option-{{$key}}").attr('data-id', {
            {
                $option - > id
            }
        });
