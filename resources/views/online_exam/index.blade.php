                    ...
                    <form class="pt-3 mt-6" id="create-form" method="POST" action="{{ route('online-exam.store') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4 col-lg-4 col-xl-4">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="{{ trans('title') }}" required>
                            </div>
                            <div class="form-group col-md-4 col-lg-4 col-xl-2">
                                <label>{{ __('exam_key') }} <span class="text-danger">*</span></label>
                                <input type="number" name="exam_key" id="key" class="form-control" placeholder="{{ trans('exam_key') }}" min="1" required>
                            </div>
                            <div class="form-group col-md-4 col-lg-4 col-xl-2">
                                <label>{{ __('duration') }} <span class="text-danger">*</span> <span class="text-info small">( {{__('in_minutes')}} )</span></label>
                                <input type="number" name="duration" id="duration" class="form-control" placeholder="{{ trans('duration') }}" min="1" required>
                            </div>
                            <div class="form-group col-md-4 col-lg-4 col-xl-2">
                                <label>{{ __('start_date')}} <span class="text-danger">*</span></label>
                                <input type="datetime-local" name="start_date" id="start-date timepicker-example" class="form-control" placeholder="{{ trans('start_date') }}" required>
                            </div>
                            <div class="form-group col-md-4 col-lg-4 col-xl-2">
                                <label>{{ __('end_date') }} <span class="text-danger">*</span></label>
                                <input type="datetime-local" name="end_date" id="end-date" class="form-control" placeholder="{{ trans('end_date') }}" required>
                            </div>
                        </div>
                    ...
                    <div class="row" id="toolbar">
                        ...
                        <div class="form-group col-12 col-sm-12 col-md-3">
                            ...
                            <select name="session_year_id" id="filter_session_year_id" class="form-control">
                                ...
                                <option value="{{ $key }}" {{ (isset($defaultSessionYear) && $defaultSessionYear->id == $key) ? 'selected' : '' }}>{{ $year }}</option>
                                @endforeach
                            </select>
