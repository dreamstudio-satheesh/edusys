        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('gallery.update', $gallery->id) }}" method="post" class="edit-form" novalidate="novalidate" enctype="multipart/form-data" data-success-function="formSuccessFunction">
                        @csrf
                        @method('POST')
