                    ...
                    <form id="create-form" class="pt-3" action="{{ route('payroll-setting.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-6">
                                ...
                                <input type="number" name="amount" class="form-control" placeholder="{{ __('fixed_amount') }}" min="1">
                            </div>
                            <div class="form-group col-sm-12 col-md-6">
                                <label for="">{{ __('percentage') }}</label>
                                <input type="number" name="percentage" class="form-control" placeholder="{{ __('percentage') }}" min="1" max="100">
                            </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-12" id="amount-div" style="display: none">
                                    <label for="">{{ __('fixed_amount') }}</label>
                                    <input type="number" name="amount" id="amount" class="form-control" placeholder="{{ __('fixed_amount') }}" min="1">
                                </div>
                                <div class="form-group col-sm-12 col-md-12" id="percentage-div" style="display: none">
                                    <label for="">{{ __('percentage') }}</label>
                                    <input type="number" name="percentage" id="percentage" class="form-control" placeholder="{{ __('percentage') }}" min="1" max="100" required>
                                </div>
                            </div>
                        </div>
